...
🎨 **浅色方块设计**
- 柔和灰底 + 纯白卡片，干净不刺眼
- 20 格像素方块进度条（CPU / 内存 / 磁盘 / Swap）
- 方块波形迷你图，实时追踪网速与延迟
- 蓝 / 紫 / 橙 / 青四色体系，深色模式自动适配

📊 **数据可视化**
- 节点卡片：CPU / 内存 / 磁盘 / Swap 方块条 + 上下行速率波形
- 主面板：节点在线状态、最忙节点、总流量、实时网速
- 详情页 Tab：资源（CPU / 内存 / 网络 / 硬盘）/ 网络延迟
- 延迟多探测折线图 + 削峰滤波 + 时间范围缩放

✨ **细节**
- 备注标签：渐变胶囊，紧跟节点名
- 到期提醒：卡片右上角彩色小框，临期变色
- 国家代码：节点名前灰色小标签（JP/HK/DE…）
- WebSocket 每 2 秒实时推送，断线 2 秒自动轮询重连
